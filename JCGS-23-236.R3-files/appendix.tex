...
{\centering \includegraphics[width=\linewidth,]{appendix-3_files/figure-latex/simple-exponential-1} 
...
{\centering \includegraphics[width=.6\linewidth,]{appendix-3_files/figure-latex/lineup-fixed-scales-1} 
...
{\centering \subfloat[Lineup\label{fig:lineup-free-scales-1}]{\includegraphics[width=.6\linewidth,]{appendix-3_files/figure-latex/lineup-free-scales-1} }\subfloat[Overlay of null and signal panels.\label{fig:lineup-free-scales-2}]{\includegraphics[width=.2\linewidth,]{images/curvature-overlay-free-scales} }
...
{\centering \includegraphics[width=.6\linewidth,]{appendix-3_files/figure-latex/lineup-truncate-scales-1} 
...
{\centering \includegraphics[width=.6\linewidth,]{appendix-3_files/figure-latex/lineup-scale-data-1} 
...
{\centering \includegraphics[width=\linewidth,]{appendix-3_files/figure-latex/conf-mosaic-1} 
...
\begin{center}\includegraphics[width=\linewidth,]{appendix-3_files/figure-latex/unnamed-chunk-4-1} \end{center}

\begin{center}\includegraphics[width=\linewidth,]{appendix-3_files/figure-latex/unnamed-chunk-4-2} \end{center}

\begin{center}\includegraphics[width=\linewidth,]{appendix-3_files/figure-latex/unnamed-chunk-4-3} \end{center}

\begin{center}\includegraphics[width=\linewidth,]{appendix-3_files/figure-latex/unnamed-chunk-4-4} \end{center}

\begin{center}\includegraphics[width=\linewidth,]{appendix-3_files/figure-latex/unnamed-chunk-4-5} \end{center}

\begin{center}\includegraphics[width=\linewidth,]{appendix-3_files/figure-latex/unnamed-chunk-4-6} \end{center}

\subsection{Medium Curvature Null
Background}\label{medium-curvature-null-background}

\begin{center}\includegraphics[width=\linewidth,]{appendix-3_files/figure-latex/unnamed-chunk-5-1} \end{center}

\begin{center}\includegraphics[width=\linewidth,]{appendix-3_files/figure-latex/unnamed-chunk-5-2} \end{center}

\begin{center}\includegraphics[width=\linewidth,]{appendix-3_files/figure-latex/unnamed-chunk-5-3} \end{center}

\begin{center}\includegraphics[width=\linewidth,]{appendix-3_files/figure-latex/unnamed-chunk-5-4} \end{center}

\begin{center}\includegraphics[width=\linewidth,]{appendix-3_files/figure-latex/unnamed-chunk-5-5} \end{center}

\begin{center}\includegraphics[width=\linewidth,]{appendix-3_files/figure-latex/unnamed-chunk-5-6} \end{center}

\subsection{High Curvature Null
Background}\label{high-curvature-null-background}

\begin{center}\includegraphics[width=\linewidth,]{appendix-3_files/figure-latex/unnamed-chunk-6-1} \end{center}

\begin{center}\includegraphics[width=\linewidth,]{appendix-3_files/figure-latex/unnamed-chunk-6-2} \end{center}

\begin{center}\includegraphics[width=\linewidth,]{appendix-3_files/figure-latex/unnamed-chunk-6-3} \end{center}

\begin{center}\includegraphics[width=\linewidth,]{appendix-3_files/figure-latex/unnamed-chunk-6-4} \end{center}

\begin{center}\includegraphics[width=\linewidth,]{appendix-3_files/figure-latex/unnamed-chunk-6-5} \end{center}

\begin{center}\includegraphics[width=\linewidth,]{appendix-3_files/figure-latex/unnamed-chunk-6-6} \end{center}
