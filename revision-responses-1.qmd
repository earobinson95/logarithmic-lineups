...
- Fig. 3 caption and analogous text: I’m confused about Fig. 3 in (I think) two separate ways.
  ...
  + \dubcheck{If these are examples from the actual versions shown to viewers, these make a lot more sense after reading the methods, but if the figure is presented where it is in the paper it needs a little more explanation. More clearly labeling which panel is the target and giving the formulas would help.}
