...
The statistical lineup on the left presents increasing exponential data displayed on a linear scale with panel $(5 \times 2) + 3$ as the target. The lineup on the right shows increasing exponential data plotted on a log scale with panel $2 \times 2$ as the target.
