...
+ Working manuscript: <https://earobinson95.github.io/logarithmic-lineups/revision-responses-1.pdf>
...
pimage <- axis_canvas(accuracy_plot_linear, axis = 'x') + 
  draw_image(picsList[1], x = 0.5, scale = 1.5) +
  draw_image(picsList[2], x = 1.5, scale = 1.5) +
  draw_image(picsList[3], x = 2.5, scale = 1.5) +
  draw_image(picsList[4], x = 3.5, scale = 1.5) +
  draw_image(picsList[5], x = 4.5, scale = 1.5) +
  draw_image(picsList[6], x = 5.5, scale = 1.5)
...
pimage <- axis_canvas(accuracy_plot_log, axis = 'x') + 
  draw_image(picsListLog[1], x = 0.5, scale = 1.5) +
  draw_image(picsListLog[2], x = 1.5, scale = 1.5) +
  draw_image(picsListLog[3], x = 2.5, scale = 1.5) +
  draw_image(picsListLog[4], x = 3.5, scale = 1.5) +
  draw_image(picsListLog[5], x = 4.5, scale = 1.5) +
  draw_image(picsListLog[6], x = 5.5, scale = 1.5)
